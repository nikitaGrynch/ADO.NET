...
namespace ADO_NET.EFCore
{
    public class EfContext : DbContext
    {
        ...
        {
            string connectionString = @"Server=eu-central.connect.psdb.cloud;Database=ado_net;user=9az0gfaywlitsk43si23;password=pscale_pw_Y5RNNc3brnpHB6GaxYe6JyZeNP3EHIceTL6KSUkzN2i;SslMode=VerifyFull;";
            optionsBuilder.UseMySql(connectionString, ServerVersion.AutoDetect(connectionString));
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            // сидирование - первоначальное заполнение базы данными
