...
namespace ADO_NET.Migrations
{
    ...
    [Migration("20230324191135_ManagerProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManagerProduct", b =>
                {
                    ...
                    b.HasKey("ManagersId", "ProductsId");

                    b.HasIndex("ProductsId");

                    b.ToTable("ManagerProduct", (string)null);
                });

            modelBuilder.Entity("ADO_NET.EFCore.Manager", b =>
                {
                    b.HasOne("ADO_NET.EFCore.Department", "MainDep")
                        .WithMany("MainWorkers")
                        .HasForeignKey("IdMainDep")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ADO_NET.EFCore.Department", "SecDep")
                        .WithMany("SecWorkers")
            ...
            modelBuilder.Entity("ADO_NET.EFCore.Sale", b =>
                {
                    b.HasOne("ADO_NET.EFCore.Manager", "Manager")
                        .WithMany("Sales")
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ADO_NET.EFCore.Product", "Product")
                        .WithMany("Sales")
            ...
            modelBuilder.Entity("ManagerProduct", b =>
                {
                    b.HasOne("ADO_NET.EFCore.Manager", null)
                        .WithMany()
                        .HasForeignKey("ManagersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ADO_NET.EFCore.Product", null)
                        .WithMany()
